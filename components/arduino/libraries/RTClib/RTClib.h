...
#define MCP7940_NVRAM    0x20

#define DS3231_ADDRESS  0x68
#define DS3231_CONTROL  0x0E
#define DS3231_STATUSREG 0x0F
#define DS3231_NVRAM    0x14
...
// RTC based on the MCP7940 chip connected via I2C and the Wire library
enum Mcp7940SqwPinMode { MCP7940_OFF = 0x0, MCP7940_ON = 0x1, MCP7940_SquareWave1HZ = 0x00, MCP7940_SquareWave4kHz = 0x01, MCP7940_SquareWave8kHz = 0x10, MCP7940_SquareWave32kHz = 0x11 };
...
public:
    ...
    uint8_t isrunning(void);
    static DateTime now();
    static Mcp7940SqwPinMode readSqwPinMode();
    static void writeSqwPinMode(Mcp7940SqwPinMode mode);
    uint8_t readnvram(uint8_t address);
    void readnvram(uint8_t* buf, uint8_t size, uint8_t address);
    void writenvram(uint8_t address, uint8_t data);
    void writenvram(uint8_t address, uint8_t* buf, uint8_t size);
